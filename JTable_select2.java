...
import My_Classes.Select2_class;
 ...
 * @author Marius
 */
public class JTable_select2 extends javax.swing.JFrame {
    ...
    My_Classes.Select2_class s2 = new My_Classes.Select2_class();

    public JTable_select2() {
        initComponents();
        populateJTableWith();
    }
    ...
    public void populateJTableWith() {
        ...
        ArrayList<My_Classes.Select2_class> participantiList =  s2.getListS2();

        String[] colNames = {"Numar", "Tip"};
        
        Object[][] rows = new Object[participantiList.size()] [colNames.length];
        
        for (int i = 0; i < participantiList.size(); i++)
        {
            rows[i][0] = participantiList.get(i).getNrSubiect();
            rows[i][1] = participantiList.get(i).getTipSubiect();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JTable_select2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JTable_select2().setVisible(true);
            }
        });
    } 
