 ...
 * @author Marius
 */
public class JTable_select1 extends javax.swing.JFrame {
    ...
    My_Classes.Join3_class j3 = new My_Classes.Join3_class();

    public JTable_select1() {
        initComponents();
        populateJTableWith();
    }
    ...
    public void populateJTableWith() {
        ...
        ArrayList<My_Classes.Join3_class> participantiList =  j3.getListS1();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JTable_select1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JTable_select1().setVisible(true);
            }
        });
    } 
