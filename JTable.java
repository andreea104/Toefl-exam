...
public class JTable extends javax.swing.JFrame {
    ...
    public void populateJTableWith() {
        ...
        ArrayList<My_Classes.Participanti> participantiList =  member.participantiList();

        String[] colNames = {"Nume", "Prenume", "Data_nasterii", "CNP", "Sex", "Email", "Scor", "Centru_ID", "Subiecte_ID", "Programare_ID", "Proba_ID"};
        ...
        for (int i = 0; i < participantiList.size(); i++)
        {
            ...
            rows[i][2] = participantiList.get(i).getCNP();
            rows[i][3] = participantiList.get(i).getEmail();
            rows[i][4] = participantiList.get(i).getGender();
            rows[i][5] = participantiList.get(i).getDate();
            rows[i][6] = participantiList.get(i).getScore();
            rows[i][7] = participantiList.get(i).getCentru_id();
            rows[i][8] = participantiList.get(i).getSubiecte_id();
            rows[i][9] = participantiList.get(i).getProgramare_id();
            rows[i][10] = participantiList.get(i).getProba_id();
    ...
    private void initComponents() {
        ...
        jTable_Participanti_.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nume", "Prenume", "|Data nasterii", "CNP", "Sex", "Email", "Scor", "Centru_ID", "Subiecte_ID", "Programare_ID", "Proba_ID"
            }
        ));
