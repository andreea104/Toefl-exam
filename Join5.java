 ...
 * @author utente
 */
public class Join5 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String var = jTextField_Nume.getText();
       
        ArrayList<My_Classes.Join1_class> participantiList =  join1.getList5(var);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Join5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
